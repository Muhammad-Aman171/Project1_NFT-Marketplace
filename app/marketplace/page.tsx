  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 my-[10vh] gap-[2vw]">
        <MoreNfts srcImg1={Img1} name="Magic Mushroom 0325" srcImg2={Img13} imgName="Shroomie"/>
        <MoreNfts srcImg1={Img2} name="Happy Robot 032" srcImg2={Img14} imgName="BeKind2Robots"/>
        <MoreNfts srcImg1={Img3} name="Happy Robot 024" srcImg2={Img14} imgName="BeKind2Robots"/>
        <MoreNfts srcImg1={Img4} name="Designer Bear" srcImg2={Img15} imgName="Mr Fox"/>
        <MoreNfts srcImg1={Img5} name="Colorful Dog 0356" srcImg2={Img16} imgName="Keepitreal"/>
        <MoreNfts srcImg1={Img6} name="Dancing Robot 0312" srcImg2={Img17} imgName="Robotica"/>
        <MoreNfts srcImg1={Img7} name="Cherry Blossom Girl " srcImg2={Img18} imgName="MoonDancer"/>
        <MoreNfts srcImg1={Img8} name="Space Travel" srcImg2={Img19} imgName="NebulaKid"/>
        <MoreNfts srcImg1={Img9} name="Sunset Dimension" srcImg2={Img20} imgName="Animakid"/>
        <MoreNfts srcImg1={Img10} name="Desert Walk" srcImg2={Img21} imgName="Catch 22"/>
        <MoreNfts srcImg1={Img11} name="IceCream Ape 0324" srcImg2={Img22} imgName="Ice Ape Club"/>
        <MoreNfts srcImg1={Img12} name="Colorful Dog 0344" srcImg2={Img23} imgName="PuppyPower"/>
      </div>
    </div>
  );
};
