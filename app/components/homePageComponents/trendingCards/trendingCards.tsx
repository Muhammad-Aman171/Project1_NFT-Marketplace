  ...
  return (
    <div className={`trending-cards ${style} `}>
      <div className="inner-cards">
        <div className="img1">
          <Image src={srcImg1!} alt="img1 does not show" className="" />
        </div>
        <div className="small-imgs">
          <div className="img2">
            <Image src={srcImg2!} alt="img1 does not show" className="" />
          </div>
          <div className="img3">
            <Image src={srcImg3!} alt="img1 does not show" className="" />
          </div>
        ...
        <div className="last-img flex items-center ">
          ...
          />
          <h6 className="font-light text-[1vw] max-md:text-[2vw]     ">
            {personName}
          </h6>
        </div>
      </div>
